...
<div class="checkWarp">
    <el-container>
        <el-main>
          <el-form :model="info" status-icon  ref="info" label-width="100px" class="demo-ruleForm" :disabled='disabled'>
            ...
            <el-form-item label="文章内容:" prop="articleContent" >
             ...
             <el-form-item label="视频上传:" prop="videoPath">
                  <el-upload
                    ...
                    <video v-if="info.articleImgPath" controls="controls" :src="info.articleImgPath" class="avatar"></video>
                    <i v-else class="el-icon-plus avatar-uploader-icon"></i>
                </el-upload>         
     ...
     operateCheckArticle(x,y,a,b){
         ...
         let tags= this.info.articleTags.join(',')
          let user=JSON.parse(localStorage['users'])
            ...
            params.id = this.info.id                  //  文章版本信息id，必填
