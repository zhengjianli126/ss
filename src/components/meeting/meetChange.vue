...
<div class="meeting">
    ...
    <div class="meetbase1">
      ...
      <div class="basedata" v-for='(list1,index) in listsDate' v-bind:key='list1.id' style="">
          ...
          <el-collapse v-model="activeNames" @change="handleChange">
            <div v-for='(list,index) in lists' v-bind:key='list.id' style="background:#fff;border-top:1px solid #eee;border-bottom:1px solid #eee;margin:0 5px;">
              <span style="font-size:14px;display:inline-block;padding-bottom:10px;margin-left:5px;margin-top:10px;">课程1：</span><div v-on:click='lists.splice(index, 1)' style="float:right;margin-top:10px;"><i class="el-icon-delete"></i></div>
    ...
    <div class="meetbase1">
      ...
      <div class="basedata" v-for='(list1,index) in listsPerson' v-bind:key='list1.id' :ref="index"  @click="clickItem(index)">
