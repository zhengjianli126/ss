;(function() {
   ...
   * @private
   */
  define("tinymce.plugins.upload.Plugin", [
    "tinymce.core.dom.DOMUtils",
    "tinymce.core.PluginManager"
  ], function(DOMUtils, PluginManager) {
    PluginManager.add("upload", function(editor) {
      function showDialog() {
        ...
        fileInput.addEventListener("input", function() {
          ...
          data.append("Filedata", this.files[0])
          ...
          request.addEventListener("load", function() {
            if (
              ...
              editor.insertContent(
                ['<img src="', request.response.data.url, '">'].join("")
              )
            }
          })
      ...
      editor.addCommand("mceUploadEditor", showDialog)
  ...
  dem("tinymce.plugins.upload.Plugin")()
})()
